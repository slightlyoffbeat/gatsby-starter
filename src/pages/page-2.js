...
const SecondPage = () => (
  <Container>
    ...
    <p>
      <kbd>
        This is text the user is supposed to enter in, or keyboard, made with
        kbd.
      </kbd>{' '}
      <var>This is a variable, made with var.</var>{' '}
      <samp>This is sample program output, made with samp.</samp>
    </p>
    <p>
      <small>This is small text, made with small.</small>{' '}
      <big>This is big text, made with big.</big>
    </p>
    <p>
      <cite>This is a citation, made with cite.</cite> This is a{' '}
      <q>short quotation</q> in the middle of a sentence, made with q.
    </p>
    <p>
      This sentence ends with a <sup>superscript</sup>. This sentence ends with
      a <sub>subscript</sub>.
    </p>
    <p>
      This is an abbreviation, made with abbr: <abbr>WWW</abbr>. This is an
      acronym, made with acronym: <acronym>NATO</acronym>. This is a term that
      needs a definition, made with dfn: <dfn>Yog-Sothoth</dfn>.
    </p>
    ...
    <p>This is an address with breaks:</p>
    <address>John Q. Public</address>
    <p>This is a long quotation inside a blockquote:</p>
    <blockquote>
      <p>
    ...
    <p>This is pre-formatted:</p>
    <pre>
      Start in column one. Then indent to column ten. Then back five spaces.
    </pre>
    <p>
      Here's a table with a border, a caption, colgroups, cols, thead, tfoot, &
      tbody:
    </p>
    <table border="1">
